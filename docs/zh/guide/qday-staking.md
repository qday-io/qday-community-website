...
- 登入您的 EVM 錢包(例如 MetaMask)並新增 QDay 主網為自訂網路。詳細步驟請參考 [MetaMask 錢包帳戶用戶指引 - 新增 QDay 網路](/zh/guide/metamask#新增-qday-網路到-metamask)。
  ...
  ![新增 QDay 主網到 MetaMask](/qday/staking/image1.png)
  
  ![QDay 主網新增成功](/qday/staking/image2.png)
...
- 點擊 **「QDAY 質押(QDAY Staking)」** 分頁,它將重新導向至 QDAY 質押頁面。
  ...
  ![QDAY 質押頁面導航](/qday/staking/image3.png)

- 點擊 **「連接錢包(Connect Wallet)」** 並連結您的錢包。

  ![連接錢包介面](/qday/staking/image4.png)
...
:::
  ...
  ![質押介面,輸入數量和鎖定期限](/qday/staking/image5.png)

- 在 **「Your Staking Stats」** 區段檢查您的質押狀態

  ![質押統計資料顯示](/qday/staking/image6.png)

### 步驟 4: 獎勵與提領

**每日獎勵** 自動累積 → **領取** 您的待領獎勵 → 從您的金庫餘額 **提領** 至您的 EVM 錢包。

  ![獎勵領取與提領介面](/qday/staking/image7.png)
