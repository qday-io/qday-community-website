...
export default defineConfig({
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { text: 'Abelian Bridge v4', link: '/guide/abelian-bridge-v4' },
                    { text: 'Abelian Bridge v3', link: '/guide/abelian-bridge-v3' },
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { text: 'Abelian 跨鏈橋 v4', link: '/zh/guide/abelian-bridge-v4' },
                    { text: 'Abelian 跨鏈橋 v3', link: '/zh/guide/abelian-bridge-v3' },
  ...
  themeConfig: {
    ...
    socialLinks: [
      ...
      { icon: 'github', link: 'https://github.com/qday-io' }
    ],
  }
